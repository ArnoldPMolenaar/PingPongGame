...
namespace PingPong
{
    ...
    {
        public AI(Game game, Texture2D Texture, Vector2 Position, float Speed, SpriteFont Font) : base(game)
        {
            texture = Texture;
            position = Position;
            speed = Speed;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(font, score.ToString(), new Vector2(game.Window.ClientBounds.Width / 2 / 2 + game.Window.ClientBounds.Width / 2, 10), Color.White);
        }
    }
}
